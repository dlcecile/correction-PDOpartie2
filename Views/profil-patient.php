...
<div class="row">
    <div class="card col-sm-10 offset-2 bg-light">
        <div class="card-header font-weight-bold bg-info">
            <h1>Modifier une fiche patient</h1>
        </div>
        <form method="post" action="#">
            ...
            <a href="../Controllers/update-patientController.php?idPatient=<?= $patient->id ?>" class="btn btn-outline-primary float-right mt-4">Modifier les informations du patient</a>
